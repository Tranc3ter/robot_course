...
def main():
    ...
    main()
```
### 代码具体实现效果见tracking_working.mp4


## 提出三个问题并自答
- *opencv的颜色空间*：默认BRG格式使用cv2.cvtColor(img, code)来进行颜色空间转换
- *opencv的HSV*：H是色相，S是饱和度，V是明度
- *边界追踪的算法原理*：来自于 Suzuki & Abe 算法
